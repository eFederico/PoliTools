var editorExtensionId = "fbbjhoaakfhbggkegckmjafkffaofnkd"; //nplaohabimjoihlnionfmknlephplhaf
		...
		$scope.$watch('$viewContentLoaded', 
			function() { 
				$timeout(function() {
					...
					loadjsfile("chrome-extension://"+editorExtensionId+"/lib/FileSaver.min.js");
					loadjsfile("chrome-extension://"+editorExtensionId+"/lib/jszip.min.js");
					loadjsfile("chrome-extension://"+editorExtensionId+"/lib/jszip-utils.min.js");
